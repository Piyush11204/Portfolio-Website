...
// Your actual social media data
const socialData = {
  github: "https://github.com/Piyush11204",
  linkedin: "https://www.linkedin.com/in/piyush-yadav-23b8ba2a3/",
  twitter: "https://x.com/piyushyadav", // Update with your actual Twitter handle
  instagram: "https://www.instagram.com/piyush.afk/",
  portfolio: "https://portfolio-v1-student.vercel.app/",
  resume: "/resume.pdf" // Add your resume to the public folder
};
...
const SocialIcons = () => {
  ...
  return (
    <div className="icons-section">
      ...
      <a className="resume-button" href={socialData.resume} target="_blank" rel="noopener noreferrer">
